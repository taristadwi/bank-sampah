...
<html class="no-js" lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e(config('app.name', 'Laravel')); ?> | Success Payment </title>
   ...
   <div class="container">
        ...
        <div class="test">
            <a href="<?php echo e(route('orders.index')); ?>" class="btn btn-warning text-white rounded">Your Order</a>
            <a href="<?php echo e(route('homepage')); ?>" class="btn btn-primary text-white rounded">Homepage</a>
        </div>
        </div>
   </div>
...
<?php /**PATH /Volumes/Storage/Document/project/joki/laravel-ecommerce/resources/views/frontend/payments/success.blade.php ENDPATH**/ ?>