						...
						<div class="row">
							<div class="col-md-12">
								<div class="checkout-form-list">
                                    ...
                                    <input type="text" name="username" value="<?php echo e(auth()->user()->username); ?>" placeholder="Username ...">
								</div>
							</div>
							<div class="col-md-6">
								<div class="checkout-form-list">
									<label>First Name <span class="required">*</span></label>
                                    <input type="text" name="first_name" value="<?php echo e(auth()->user()->first_name); ?>" placeholder="First Name ...">
								</div>
							</div>
							<div class="col-md-6">
								<div class="checkout-form-list">
									<label>Last Name <span class="required">*</span></label>
                                    <input type="text" name="last_name" value="<?php echo e(auth()->user()->last_name); ?>" placeholder="Last Name ...">
								</div>
							</div>
							<div class="col-md-12">
								<div class="checkout-form-list">
									<label>Address <span class="required">*</span></label>
                                    <input type="text" name="address1" value="<?php echo e(auth()->user()->address1); ?>" placeholder="Home number and street name...">
								</div>
							</div>
							<div class="col-md-12">
								<div class="checkout-form-list">
                                <input type="text" name="address2" value="<?php echo e(auth()->user()->address2); ?>" placeholder="Apartment, suite, unit etc. (optional)...">
								</div>
							</div>
							<div class="col-md-12">
								<div class="checkout-form-list">
							...
							<div class="col-md-6">
								<div class="checkout-form-list">
									...
									<input type="text" name="phone" placeholder="Phone..." value="<?php echo e(auth()->user()->phone); ?>">
								</div>
							</div>
							<div class="col-md-6">
								<div class="checkout-form-list">
									<label>Email Address </label>
									<input type="text" name="email" readonly placeholder="Email..." value="<?php echo e(auth()->user()->email); ?>">								
								</div>
							</div>							
						</div>
							...
							<table>
									...
									<?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
										...
										<tr class="cart_item">
											...
											<td class="product-total">
												<span class="amount"><?php echo e(number_format(\Cart::get($item->id)->getPriceSum())); ?></span>
											</td>
										</tr>
								...
								<tfoot>
									<tr class="cart-subtotal">
										<th>Subtotal</th>
										<td><span class="amount"><?php echo e(number_format(\Cart::getSubTotal())); ?></span></td>
									</tr>
									<tr class="cart-subtotal">
										<th>Tax</th>
										<td><span class="amount"><?php echo e(number_format(\Cart::getSubTotal())); ?></span></td>
									...
									<tr class="cart-subtotal">
										<th>Shipping Cost (<?php echo e($totalWeight); ?> gram)</th>
										<td><select id="shipping-cost-option" required name="shipping_service"></select></td>
									</tr>
									<tr class="order-total">
										<th>Order Total</th>
										<td><strong><span class="total-amount"><?php echo e(number_format(\Cart::getTotal())); ?></span></strong>
										</td>
									</tr>								
								</tfoot>
							</table>
									...
									<div class="panel panel-default">
										...
										<div id="payment-1" class="panel-collapse collapse show">
											<div class="panel-body">
												<p>Make your payment directly into one of our bank accounts. Please upload proof of payment after completing the transfer.</p>
													...
													<select name="bank_account_id" id="bank_account_id" class="form-control" required>
														...
														<?php $__currentLoopData = $bankAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bankAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
															<option value="<?php echo e($bankAccount->id); ?>">
																<?php echo e($bankAccount->bank_name); ?> - <?php echo e($bankAccount->account_number); ?> (<?php echo e($bankAccount->account_holder); ?>)
															</option>
														<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
													</select>
												</div>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/Storage/Document/project/joki/laravel-ecommerce/resources/views/frontend/orders/checkout.blade.php ENDPATH**/ ?>