            ...
            <li class="nav-item">
                ...
                <div id="collapseProduct" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item {{ request()->is('admin/slides') || request()->is('admin/slides/*') ? 'active' : '' }}" href="{{ route('admin.bank_accounts.index') }}"> <i class="fa fa-briefcase mr-2"></i> {{ __('Bank Account') }}</a>
                        @endif
                    </div>
                </div>
            </li>
