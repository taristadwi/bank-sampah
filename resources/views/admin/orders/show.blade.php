        ...
        <div class="invoice-wrapper rounded border bg-white py-5 px-3 px-md-4 px-lg-5">
            ...
            <div class="row pt-5">
                <div class="col-xl-6 col-lg-6">
                    ...
                    <address>
                        Bank Name: {{ $order->bankAccount->bank_name ?? 'N/A' }}
                        <br> Account Number: {{ $order->bankAccount->account_number ?? 'N/A' }}
                        <br> Account Holder: {{ $order->bankAccount->account_holder ?? 'N/A' }}
                    </address>
                    <p class="text-dark mb-2" style="font-weight: normal; font-size:16px; text-transform: uppercase;">Bukti Pembayaran</p>
                    @if ($order->payment_proof)
                        <a href="{{ asset('storage/payment_proofs/' . $order->payment_proof) }}" target="_blank" class="text-primary">
