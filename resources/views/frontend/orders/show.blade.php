				...
				<div class="col-lg-9">
					...
					<div class="row pt-5">
						...
						<div class="col-xl-3 col-lg-3">
							...
							<address>
								<ul>
									<li><strong>Bank Name:</strong> {{ $order->bankAccount->bank_name ?? 'N/A' }}</li>
									<li><strong>Account Number:</strong> {{ $order->bankAccount->account_number ?? 'N/A' }}</li>
									<li><strong>Account Holder:</strong> {{ $order->bankAccount->account_holder ?? 'N/A' }}</li>
								</ul>
							</address>
